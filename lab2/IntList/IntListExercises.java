...
public class IntListExercises {
    ...
    public static boolean squarePrimes(IntList lst) {
        ...
        boolean rest_changed = squarePrimes(lst.rest);
        return currElemIsPrime || rest_changed;  // "or" is short-circuited
        // we can also use "return squarePrimes(lst.rest) || currElemIsPrime;"
    }
}
